...
public class Utilities {
	...
	public static boolean transitionCoverSetDebugSw = true; // To or not to
															// print the
															// transition cover
															// set.
	...
	public static String runFSM(State[] FSM, int stateID, String input, String separator) {
		...
		// input is a sequence of symbols from the input alphabet separated by
		// string in separator.
		// StateId is the ID of the state to which input is to be applied.
		String outputPattern = ""; // Output sequence generated by the FSM.
									// Illegal input generates empty output.
		...
		while (inputTokens.hasMoreTokens()) {
			...
			try {
				// Utilities.debugFSMExecution("Current state: " +
				// currentState);
				...
				// Utilities.debugFSMExecution(" Input: " + token + " Next
				// state:" + nextState + " Output: " + outputGenerated);
				currentState = nextState;
			} catch (NoNextStateException e) {
				// Utilities.printException("WMethod", "runFSM", " Invalidtoken:
				// " + token);
			}
		}

...
/**
 * The class <code>JamesBondTest</code> contains tests for the class
 * {@link <code>JamesBond</code>}
 *
 * @pattern JUnit Test Case
 *
 * @generatedBy CodePro at 4/21/17 9:09 PM
 *
 * @author scott
 *
 * @version $Revision$
...
public class JamesBondTest extends TestCase {
	 ...
	 *            the test name
	 */
	public JamesBondTest(String name) {
		super(name);
	}
 ...
 * createTestStubs = false methods = package = package.sourceFolder =
 * Project5/src superclassType = junit.framework.TestCase testCase =
 * JamesBondTest testClassType = JamesBond
 */